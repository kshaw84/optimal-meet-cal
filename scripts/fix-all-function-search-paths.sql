...
-- This script fixes ALL functions that are missing SET search_path = public;

-- =============================================================================
-- 1. GET ALL FUNCTION DEFINITIONS AND RECREATE THEM WITH SEARCH PATHS
-- =============================================================================
...
-- Function: refresh_routing_form_response_denormalized (second occurrence)
CREATE OR REPLACE FUNCTION refresh_routing_form_response_denormalized()
RETURNS void AS $$
BEGIN
    SET search_path = public;
...
-- Function: calculate_is_team_booking
...
-- Function: reprocess_routing_form_response_fields (second occurrence)
CREATE OR REPLACE FUNCTION reprocess_routing_form_response_fields(response_id integer)
RETURNS void
LANGUAGE plpgsql
AS $function$
...
-- Function: _process_routing_form_response_fields (second occurrence)
CREATE OR REPLACE FUNCTION _process_routing_form_response_fields(response_id integer, response_data jsonb, form_id text)
RETURNS void
LANGUAGE plpgsql
AS $function$
...
-- Function: refresh_booking_time_status_denormalized (second occurrence)
CREATE OR REPLACE FUNCTION refresh_booking_time_status_denormalized()
RETURNS void AS $$
BEGIN
    SET search_path = public;
