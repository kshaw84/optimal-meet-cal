...
-- This script fixes ALL security issues identified by Supabase Splinter

-- =============================================================================
-- 1. FIX ALL FUNCTIONS WITH EXPLICIT SEARCH PATHS
-- =============================================================================
...
-- =============================================================================
-- 2. FIX ALL REMAINING FUNCTIONS WITH SEARCH PATH
-- =============================================================================

-- Get all functions that don't have SET search_path and update them
DO $$
DECLARE
    func_record RECORD;
...
BEGIN
    ...
    FOR func_record IN 
        ...
        AND p.proname NOT IN (
            ...
            'refresh_routing_form_response_denormalized',
            'trigger_refresh_routing_form_response_denormalized',
            'trigger_delete_routing_form_response_denormalized',
            'trigger_refresh_routing_form_response_denormalized_form_name',
            'trigger_refresh_routing_form_response_denormalized_form_team',
            'trigger_refresh_routing_form_response_denormalized_form_user',
            'trigger_refresh_routing_form_response_denormalized_booking',
            'trigger_refresh_routing_form_response_denormalized_user',
            'trigger_refresh_routing_form_response_denormalized_event_type',
            'trigger_cleanup_routing_form_response_denormalized_form',
            'trigger_cleanup_routing_form_response_denormalized_user',
            'trigger_nullify_routing_form_response_denormalized_event_type',
            'update_membership_custom_role',
            'update_updated_at_column',
            'refresh_booking_time_status_length',
            'refresh_booking_time_status_parent_id',
            'refresh_booking_time_status_team_id',
            'reprocess_routing_form_response_fields',
            'trigger_delete_booking_time_status_denormalized',
            'trigger_refresh_booking_time_status_denormalized',
            'trigger_refresh_booking_time_status_denormalized_user',
            'trigger_refresh_routing_form_response_denormalized',
            'trigger_refresh_routing_form_response_denormalized_booking',
            '_process_routing_form_response_fields',
            'handle_routing_form_response_fields',
            'refresh_booking_time_status_denormalized',
            'refresh_routing_form_response_denormalized'
        )
    ...
    LOOP
        -- Add SET search_path = public; after BEGIN
...
-- =============================================================================
-- 3. FORCE RECREATE VIEWS WITHOUT SECURITY DEFINER
-- =============================================================================

-- Drop and recreate RoutingFormResponse view
...
-- Drop and recreate BookingTimeStatus view
...
-- Drop and recreate BookingTimeStatusDenormalized view
...
-- Check how many functions now have explicit search paths
SELECT 'Functions with explicit search_path' as status, count(*) as count
FROM pg_proc p
JOIN pg_namespace n ON p.pronamespace = n.oid
WHERE n.nspname = 'public'
    AND p.prolang = (SELECT oid FROM pg_language WHERE lanname = 'plpgsql')
